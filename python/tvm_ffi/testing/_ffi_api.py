...
if TYPE_CHECKING:
    ...
    from tvm_ffi import Device, Dict, Object, Tensor, dtype
...
if TYPE_CHECKING:
    ...
    def schema_id_dict_str_int(_0: Dict[str, int], /) -> Dict[str, int]: ...
    def schema_id_dict_str_obj(_0: Dict[str, Object], /) -> Dict[str, Object]: ...
    def schema_id_dict_str_str(_0: Dict[str, str], /) -> Dict[str, str]: ...
