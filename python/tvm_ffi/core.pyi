...
# under the License.
"""Type stubs for Cython-backed ``tvm_ffi.core`` APIs.

The implementation lives in Cython modules; this file describes the Python
surface used by the rest of the package, including FFI object handles,
reflection metadata, packed functions, tensors, devices, and helper entry
points used by the dataclass decorators.
"""
...
def _type_index_to_type_info(type_index: int) -> TypeInfo | None: ...
...
def _register_opaque_ptr(type_cls: type, func: Callable[[Any], int], override: bool) -> Any: ...
def _remove_opaque_ptr(type_cls: type, allow_missing: bool) -> None: ...
...
def _register_fields(
    type_info: TypeInfo, fields: list[Any], structure_kind: int | None = ...
) -> list[TypeField]: ...
