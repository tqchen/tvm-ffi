...
if TYPE_CHECKING:
    ...
    from tvm_ffi import Device, Module, Object, StructuralKey as _StructuralKey, StructuralMutator as _StructuralMutator, StructuralVisitor as _StructuralVisitor, VisitInterrupt as _VisitInterrupt
...
if TYPE_CHECKING:
    ...
    def StructuralMap(_0: Any, _1: Sequence[tuple[int, Callable[..., Any]]], _2: Sequence[tuple[int, Callable[..., Any]]], _3: int, /) -> Any: ...
    def StructuralMutate(_0: Any, _1: Sequence[tuple[int, Callable[..., Any]]], /) -> Any: ...
    def StructuralMutatorDefRegionKind(_0: _StructuralMutator, /) -> int: ...
    def StructuralMutatorMaybeInplaceMutate(_0: _StructuralMutator, _1: Any, /) -> Any: ...
    def StructuralMutatorMutate(_0: _StructuralMutator, _1: Any, /) -> Any: ...
    def StructuralMutatorVarRemapGet(_0: _StructuralMutator, _1: Any, /) -> Any: ...
    def StructuralMutatorVarRemapSet(_0: _StructuralMutator, _1: Any, _2: Any, /) -> None: ...
    def StructuralMutatorWithDefRegionKind(_0: _StructuralMutator, _1: int, _2: Callable[..., Any], /) -> Any: ...
    def StructuralVisit(_0: Any, _1: Sequence[tuple[int, Callable[..., Any]]], /) -> _VisitInterrupt | None: ...
    def StructuralVisitorDefRegionKind(_0: _StructuralVisitor, /) -> int: ...
    def StructuralVisitorDefaultVisit(_0: _StructuralVisitor, _1: Any, /) -> _VisitInterrupt | None: ...
    ...
    def StructuralWalk(_0: Any, _1: Sequence[tuple[int, Callable[..., Any]]], _2: Sequence[tuple[int, Callable[..., Any]]], _3: int, /) -> _VisitInterrupt | None: ...
