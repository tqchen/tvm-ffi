...
Dict<String, ObjectRef> schema_id_dict_str_obj(Dict<String, ObjectRef> d) { return d; }
...
TVM_FFI_STATIC_INIT_BLOCK() {
  ...
  refl::GlobalDef()
      ...
      .def("testing.schema_id_dict_str_obj", schema_test_impl::schema_id_dict_str_obj)
